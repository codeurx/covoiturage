...
<head>
    ...
    <title>Covoiturage - Connexion</title>
</head>
<body>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center">
                <h1 class="main-heading ins">Se Connecter</h1>
            </div>
            <form id="cnx" class="form-horizontal">
                ...
                <button id="submit_cnx" class="btn btn-success">Se Connecter</button>
            </form>
        </div>
        <div class="col-md-12">
            <br><br>
